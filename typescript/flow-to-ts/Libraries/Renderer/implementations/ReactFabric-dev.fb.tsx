yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Renderer/implementations/ReactFabric-dev.fb.js
'use strict';
...
if (__DEV__) {
  (function () {"use strict";
    ...
    var cloneNodeWithNewChildrenAndProps = _nativeFabricUIManage.cloneNodeWithNewChildrenAndProps;
    ...
    function DEPRECATED_mountResponderInstance(responder, responderInstance, props, state, instance) {
      throw new Error("Not yet implemented.");
    }
    ...
    function beforeRemoveInstance(instance) {// noop
    }
    ...
    function describeFiber(fiber) {
      switch (fiber.tag) {
        case HostRoot:case HostPortal:case HostText:case Fragment:case ContextProvider:case ContextConsumer:
          return "";
    ...
    var shouldIgnoreFiber = function (fiber) {
      ...
      switch (fiber.tag) {
        case HostRoot:case HostComponent:case HostText:case HostPortal:case Fragment:case ContextProvider:case ContextConsumer:case Mode:
          return true;
    ...
    function scheduleFibersWithFamiliesRecursively(fiber, updatedFamilies, staleFamilies) {
      {
        ...
        switch (tag) {
          case FunctionComponent:case SimpleMemoComponent:case ClassComponent:
            candidateType = type;
            break;
      ...
      function warnOnInvalidKey(child, knownKeys) {
        {
          ...
          switch (child.$$typeof) {
            case REACT_ELEMENT_TYPE:case REACT_PORTAL_TYPE:
    ...
    var workInProgressHook = null; // Updates scheduled during render will trigger an immediate re-render at the
    ...
    function updateReducer(reducer, initialArg, init) {
      ...
      if (baseQueue !== null) {
        ...
        var _newState = current.baseState;
        var newBaseState = null;
        var newBaseQueueFirst = null;
        var newBaseQueueLast = null;
        var _update = first;
    ...
    function dispatchAction(fiber, queue, action) {
      ...
      if (fiber === currentlyRenderingFiber$1 || alternate !== null && alternate === currentlyRenderingFiber$1) {
        ...
        if (pending === null) {
          ...
          _update2.next = pending.next;
          pending.next = _update2;
        }

        queue.pending = _update2;
        ...
        if (revealOrder !== undefined && revealOrder !== "forwards" && revealOrder !== "backwards" && revealOrder !== "together" && !didWarnAboutRevealOrder[revealOrder]) {
          ...
          if (typeof revealOrder === "string") {
            switch (revealOrder.toLowerCase()) {
              case "together":case "forwards":case "backwards":
                {
    ...
    function completeWork(current, workInProgress, renderExpirationTime) {
      ...
      switch (workInProgress.tag) {
        case IndeterminateComponent:case LazyComponent:case SimpleMemoComponent:case FunctionComponent:case ForwardRef:case Fragment:case Mode:case Profiler:case ContextConsumer:case MemoComponent:
          return null;
    ...
    function commitBeforeMutationLifeCycles(current$$1, finishedWork) {
      switch (finishedWork.tag) {
        case FunctionComponent:case ForwardRef:case SimpleMemoComponent:case Chunk:
          {
        ...
        case HostRoot:case HostComponent:case HostText:case HostPortal:case IncompleteClassComponent:
    ...
    function commitLifeCycles(finishedRoot, current$$1, finishedWork, committedExpirationTime) {
      switch (finishedWork.tag) {
        ...
        case SuspenseListComponent:case IncompleteClassComponent:case FundamentalComponent:case ScopeComponent:
          return;
    ...
    function commitUnmount(finishedRoot, current$$1, renderPriorityLevel) {
      ...
      switch (current$$1.tag) {
        case FunctionComponent:case ForwardRef:case MemoComponent:case SimpleMemoComponent:case Chunk:
          {
    ...
    function commitContainer(finishedWork) {
      ...
      switch (finishedWork.tag) {
        case ClassComponent:case HostComponent:case HostText:case FundamentalComponent:
          {
            return;
          }
    ...
    function computeExpirationForFiber(currentTime, fiber, suspenseConfig) {
      ...
      if (suspenseConfig !== null) {
        ...
        switch (priorityLevel) {
          ...
          case NormalPriority:case LowPriority:
            // TODO: Handle LowPriority
    ...
    function createWorkInProgress(current, pendingProps, expirationTime) {
...

      {
        ...
        switch (workInProgress.tag) {
          case IndeterminateComponent:case FunctionComponent:case SimpleMemoComponent:
    ...
    var ReactVersion = "16.12.0-experimental-19f6fe170";
    ...
    var NativeMethodsMixin = function (findNodeHandle, findHostInstance) {
      ...
      var NativeMethodsMixin = {
        ...
        measure: function (callback) {
          ...
          } catch (error$$1) {} // If there is no host component beneath this we should fail silently.
        ...
        /* currently unused */
        {
          ...
          if (maybeInstance.canonical) {
            {
              error("Warning: measureLayout on components using NativeMethodsMixin " + "or ReactNative.NativeComponent is not currently supported in Fabric. " + "measureLayout must be called on a native ref. Consider using forwardRef.");
            }
