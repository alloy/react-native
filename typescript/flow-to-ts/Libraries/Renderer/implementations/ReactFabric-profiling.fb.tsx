yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Renderer/implementations/ReactFabric-profiling.fb.js
"use strict";
...
function dispatchEvent(target, topLevelType, nativeEvent) {
  ...
  enableNativeTargetAsInstance ? null != target && (eventTarget = target.stateNode.canonical) : eventTarget = nativeEvent.target;
...
function createTextInstance(text, rootContainerInstance, hostContext, internalInstanceHandle) {
  ...
  nextReactTag += 2;
  return {
    node: createNode(hostContext, "RCTRawText", rootContainerInstance, { text: text }, internalInstanceHandle)
  };
}
...
function cloneHiddenInstance(instance) {
  ...
  var updatePayload = diffProperties(null, emptyObject, { style: { display: "none" } }, instance.canonical.viewConfig.validAttributes);
  return {
  ...
  for (var node = workInProgress.child; null !== node;) {
    if (5 === node.tag) {
      ...
      if (13 === node.tag && 0 !== (node.effectTag & 4) && (instance = null !== node.memoizedState)) {
        ...
        if (null !== primaryChildParent && (null !== primaryChildParent.child && (primaryChildParent.child.return = primaryChildParent, appendAllChildren(parent, primaryChildParent, !0, instance)), instance = primaryChildParent.sibling, null !== instance)) {
...
updateHostComponent$1 = function (current, workInProgress, type, newProps) {
  ...
  if ((current = null === workInProgress.firstEffect) && oldProps === newProps) workInProgress.stateNode = type;else {
    ...
    }, workInProgress.stateNode = type, current ? workInProgress.effectTag |= 4 : appendAllChildren(type, workInProgress, !1, !1));
  }
};
  ...
  switch (workInProgress.tag) {
    ...
    case 5:
      ...
      if (null !== current && null != workInProgress.stateNode) updateHostComponent$1(current, workInProgress, renderExpirationTime$jscomp$0, newProps, rootContainerInstance), current.ref !== workInProgress.ref && (workInProgress.effectTag |= 128);else {
        ...
        nextReactTag += 2;
        renderExpirationTime$jscomp$0 = getViewConfigForType(renderExpirationTime$jscomp$0);
        var updatePayload = diffProperties(null, emptyObject, newProps, renderExpirationTime$jscomp$0.validAttributes);
        rootContainerInstance = createNode(current, renderExpirationTime$jscomp$0.uiViewClassName, rootContainerInstance, updatePayload, workInProgress);
        current = new ReactFabricHostComponent(current, renderExpirationTime$jscomp$0, newProps, workInProgress);
    ...
    case 13:
      ...
      null !== current && (renderExpirationTime$jscomp$0 = current.memoizedState, rootContainerInstance = null !== renderExpirationTime$jscomp$0, newProps || null === renderExpirationTime$jscomp$0 || (renderExpirationTime$jscomp$0 = current.child.sibling, null !== renderExpirationTime$jscomp$0 && (updatePayload = workInProgress.firstEffect, null !== updatePayload ? (workInProgress.firstEffect = renderExpirationTime$jscomp$0, renderExpirationTime$jscomp$0.nextEffect = updatePayload) : (workInProgress.firstEffect = workInProgress.lastEffect = renderExpirationTime$jscomp$0, renderExpirationTime$jscomp$0.nextEffect = null), renderExpirationTime$jscomp$0.effectTag = 8)));
...
function commitLifeCycles(finishedRoot, current$$1, finishedWork, committedExpirationTime) {
  switch (finishedWork.tag) {
    ...
    case 3:
      ...
      return;
    case 5:
      if (null === current$$1 && finishedWork.effectTag & 4) throw Error("The current renderer does not support mutation. This error is likely caused by a bug in React. Please file an issue.");
      return;
    case 6:
      return;
    case 4:
...
function commitRootImpl(root$jscomp$1, renderPriorityLevel$jscomp$1) {
  ...
  root$jscomp$1 === workInProgressRoot && (workInProgress = workInProgressRoot = null, renderExpirationTime = 0);
  ...
  if (null !== remainingExpirationTimeBeforeCommit) {
      ...
      for (var root = root$jscomp$1, renderPriorityLevel = renderPriorityLevel$jscomp$1; null !== nextEffect;) {
        ...
        switch (effectTag & 1038) {
          ...
          case 8:
            ...
            a: for (var finishedRoot = root, root$jscomp$0 = current$$1$jscomp$0, renderPriorityLevel$jscomp$0 = renderPriorityLevel, node = root$jscomp$0;;) if (commitUnmount(finishedRoot, node, renderPriorityLevel$jscomp$0), null !== node.child) node.child.return = node, node = node.child;else {
    ...
    nextEffect = remainingExpirationTimeBeforeCommit;
    do try {
      for (effectTag = root$jscomp$1, current$$1 = expirationTime; null !== nextEffect;) {
  ...
  if (effectTag$jscomp$0 = rootDoesHavePassiveEffects) rootDoesHavePassiveEffects = !1, rootWithPendingPassiveEffects = root$jscomp$1, pendingPassiveEffectsExpirationTime = expirationTime, pendingPassiveEffectsRenderPriority = renderPriorityLevel$jscomp$1;else for (nextEffect = remainingExpirationTimeBeforeCommit; null !== nextEffect;) renderPriorityLevel$jscomp$1 = nextEffect.nextEffect, nextEffect.nextEffect = null, nextEffect = renderPriorityLevel$jscomp$1;
  renderPriorityLevel$jscomp$1 = root$jscomp$1.firstPendingTime;
  if (0 !== renderPriorityLevel$jscomp$1) {
    if (null !== spawnedWorkDuringRender) for (remainingExpirationTimeBeforeCommit = spawnedWorkDuringRender, spawnedWorkDuringRender = null, ref = 0; ref < remainingExpirationTimeBeforeCommit.length; ref++) scheduleInteractions(root$jscomp$1, remainingExpirationTimeBeforeCommit[ref], root$jscomp$1.memoizedInteractions);
    schedulePendingInteractions(root$jscomp$1, renderPriorityLevel$jscomp$1);
  } else legacyErrorBoundariesThatAlreadyFailed = null;
  effectTag$jscomp$0 || finishPendingInteractions(root$jscomp$1, expirationTime);
