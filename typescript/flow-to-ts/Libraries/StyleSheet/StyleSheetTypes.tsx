...
type ____TransformStyle_Internal = $ReadOnly<{
   ...
   */
  transform?: ReadonlyArray<{readonly perspective: number | AnimatedNode;} | {readonly rotate: string | AnimatedNode;} | {readonly rotateX: string | AnimatedNode;} | {readonly rotateY: string | AnimatedNode;} | {readonly rotateZ: string | AnimatedNode;} | {readonly scale: number | AnimatedNode;} | {readonly scaleX: number | AnimatedNode;} | {readonly scaleY: number | AnimatedNode;} | {readonly translateX: number | AnimatedNode;} | {readonly translateY: number | AnimatedNode;} | {
    readonly translate: [number | AnimatedNode, number | AnimatedNode] | AnimatedNode;
  } | {readonly skewX: string;} | {readonly skewY: string;} // TODO: what is the actual type it expects?
  | {
...
export type ____ViewStyle_Internal = $ReadOnly<$Exact<____LayoutStyle_Internal> & $Exact<____ShadowStyle_Internal> & $Exact<____TransformStyle_Internal> & {
...
export type ____FontWeight_Internal = "normal" | "bold" | "100" | "200" | "300" | "400" | "500" | "600" | "700" | "800" | "900";

export type ____TextStyle_Internal = $ReadOnly<$Exact<____ViewStyle_Internal> & {
  color?: ColorValue;
  fontFamily?: string;
  fontSize?: number;
...
export type ____ImageStyle_Internal = $ReadOnly<$Exact<____ViewStyle_Internal> & {
  resizeMode?: "contain" | "cover" | "stretch" | "center" | "repeat";
  tintColor?: ColorValue;
  overlayColor?: string;
}>;

export type ____DangerouslyImpreciseStyle_Internal = $Exact<____TextStyle_Internal> & {
...
export type ____DangerouslyImpreciseStyleProp_Internal = GenericStyleProp<$Shape<____DangerouslyImpreciseStyle_Internal>>;
export type ____ViewStyleProp_Internal = GenericStyleProp<$ReadOnly<$Shape<____ViewStyle_Internal>>>;
export type ____TextStyleProp_Internal = GenericStyleProp<$ReadOnly<$Shape<____TextStyle_Internal>>>;
export type ____ImageStyleProp_Internal = GenericStyleProp<$ReadOnly<$Shape<____ImageStyle_Internal>>>;
