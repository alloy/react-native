 ...
 */
export type TypeForStyleKey<key extends $Keys<____DangerouslyImpreciseStyle_Internal>> = $ElementType<____DangerouslyImpreciseStyle_Internal, key>;
...
module.exports = {
   ...
   * styles.
   */
  absoluteFill: (absoluteFill as any), // TODO: This should be updated after we fix downstream Flow sites.
   ...
   */
  compose<T extends DangerouslyImpreciseStyleProp>(style1: T | null | undefined, style2: T | null | undefined): (T | null | undefined) | ReadonlyArray<T> {
    if (style1 != null && style2 != null) {
      return ([style1, style2] as ReadonlyArray<T>);
    } else {
