yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Pressability/Pressability.js
'use strict';
...
export default class Pressability {
  ...
  _hoverInDelayTimeout: TimeoutID | null | undefined = null;
  _hoverOutDelayTimeout: TimeoutID | null | undefined = null;
  _isHovered: boolean = false;
  _longPressDelayTimeout: TimeoutID | null | undefined = null;
  _pressDelayTimeout: TimeoutID | null | undefined = null;
  _pressOutDelayTimeout: TimeoutID | null | undefined = null;
  _responderID: (number | null | undefined) | React.ElementRef<HostComponent<unknown>> = null;
