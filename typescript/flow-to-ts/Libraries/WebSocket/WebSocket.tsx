yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/WebSocket/WebSocket.js
'use strict';
...
class WebSocket extends (EventTarget(...WEBSOCKET_EVENTS) as any) {
  ...
  constructor(url: string, protocols: (string | null | undefined) | (Array<string> | null | undefined), options: {headers?: {origin?: string;};} | null | undefined) {
    super();
