...
const _combineCallbacks = function (callback: EndCallback | null | undefined, config: AnimationConfig) {
...
const spring = function (value: AnimatedValue | AnimatedValueXY, config: SpringAnimationConfig): CompositeAnimation {
  const start = function (animatedValue: AnimatedValue | AnimatedValueXY, configuration: SpringAnimationConfig, callback?: EndCallback | null | undefined): void {
  ...
  return maybeVectorAnim(value, config, spring) || {
    start: function (callback?: EndCallback | null | undefined): void {
...
const timing = function (value: AnimatedValue | AnimatedValueXY, config: TimingAnimationConfig): CompositeAnimation {
  const start = function (animatedValue: AnimatedValue | AnimatedValueXY, configuration: TimingAnimationConfig, callback?: EndCallback | null | undefined): void {
    callback = _combineCallbacks(callback, configuration);
    const singleValue: any = animatedValue;
    const singleConfig: any = configuration;
    singleValue.stopTracking();
...
const decay = function (value: AnimatedValue | AnimatedValueXY, config: DecayAnimationConfig): CompositeAnimation {
  const start = function (animatedValue: AnimatedValue | AnimatedValueXY, configuration: DecayAnimationConfig, callback?: EndCallback | null | undefined): void {
    callback = _combineCallbacks(callback, configuration);
    const singleValue: any = animatedValue;
    const singleConfig: any = configuration;
    singleValue.stopTracking();
...
const sequence = function (animations: Array<CompositeAnimation>): CompositeAnimation {
  let current = 0;
  return {
    start: function (callback?: EndCallback | null | undefined) {
