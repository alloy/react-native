yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Experimental/Incremental.js
'use strict';
...
class Incremental extends React.Component<Props, State> {
  ...
  render(): React.ReactNode {
    ...
    !this.context.incrementalGroupEnabled || this.state.doIncrementalRender) {
