yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/DeprecatedPropTypes/DeprecatedViewPropTypes.js
'use strict';
...
module.exports = {
   ...
   * @platform ios
   */
  accessibilityActions: (PropTypes.arrayOf(PropTypes.string) as React$PropType$Primitive<Array<string>>),
   ...
   */
  accessibilityRole: (PropTypes.oneOf(DeprecatedAccessibilityRoles) as React$PropType$Primitive<"none" | "button" | "link" | "search" | "image" | "keyboardkey" | "text" | "adjustable" | "imagebutton" | "header" | "summary" | "alert" | "checkbox" | "combobox" | "menu" | "menubar" | "menuitem" | "progressbar" | "radio" | "radiogroup" | "scrollbar" | "spinbutton" | "switch" | "tab" | "tablist" | "timer" | "toolbar">),
   ...
   */
  accessibilityLiveRegion: (PropTypes.oneOf(['none', 'polite', 'assertive']) as React$PropType$Primitive<"none" | "polite" | "assertive">),
   ...
   */
  importantForAccessibility: (PropTypes.oneOf(['auto', 'yes', 'no', 'no-hide-descendants']) as React$PropType$Primitive<"auto" | "yes" | "no" | "no-hide-descendants">),
   ...
   */
  pointerEvents: (PropTypes.oneOf(['box-none', 'none', 'box-only', 'auto']) as React$PropType$Primitive<"box-none" | "none" | "box-only" | "auto">),
