yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/BatchedBridge/MessageQueue.js
'use strict';
...
class MessageQueue {
  ...
  createDebugLookup(moduleID: number, name: string, methods: ReadonlyArray<string> | null | undefined) {
    if (__DEV__) {
