...
export type Props<SectionT> = RequiredProps<SectionT> & OptionalProps<SectionT> & $Diff<VirtualizedListProps, {renderItem: $PropertyType<VirtualizedListProps, "renderItem">;}>;
...
class VirtualizedSectionList<SectionT extends SectionBase<any>> extends React.PureComponent<Props<SectionT>, State> {
  ...
  _getItem = (props: Props<SectionT>, sections: ReadonlyArray<Item> | null | undefined, index: number): Item | null | undefined => {
    if (!sections) {
      return null;
    }
    let itemIdx = index - 1;
...
type ItemWithSeparatorProps = $ReadOnly<ItemWithSeparatorCommonProps & {
  LeadingSeparatorComponent: React.ComponentType<any> | null | undefined;
  SeparatorComponent: React.ComponentType<any> | null | undefined;
  cellKey: string;
  index: number;
  item: Item;
...
type ItemWithSeparatorState = {
  separatorProps: $ReadOnly<ItemWithSeparatorCommonProps & {
    highlighted: false;
  }>;
  leadingSeparatorProps: $ReadOnly<ItemWithSeparatorCommonProps & {
    highlighted: false;
  }>;
...
class ItemWithSeparator extends React.Component<ItemWithSeparatorProps, ItemWithSeparatorState> {
  ...
  static getDerivedStateFromProps(props: ItemWithSeparatorProps, prevState: ItemWithSeparatorState): ItemWithSeparatorState | null | undefined {
    return {
      separatorProps: {
