yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Lists/VirtualizedList.js
'use strict';
...
class VirtualizedList extends React.PureComponent<Props, State> {
  ...
  scrollToEnd(params?: {animated?: boolean | null | undefined;} | null | undefined) {
  ...
  render(): React.ReactNode {
    ...
    if (itemCount > 0) {
      ...
      const element: React.ReactElement<any> = ((React.isValidElement(ListEmptyComponent) ? ListEmptyComponent : // $FlowFixMe
  ...
  _scrollRef: React.ElementRef<any> | null | undefined = null;
    ...
    if (!frame || frame.index !== index) {
      if (getItemLayout) {
        ...
        if (__DEV__) {
          ...
          PropTypes.checkPropTypes({ frame: frameType }, { frame }, 'frame', 'VirtualizedList.getItemLayout');
        }
      }
    }
...
class CellRenderer extends React.Component<CellRendererProps, CellRendererState> {
  ...
  static getDerivedStateFromProps(props: CellRendererProps, prevState: CellRendererState): CellRendererState | null | undefined {
    return {
      separatorProps: {
