yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Core/ExceptionsManager.js
'use strict';
 ...
 */
function unstable_setExceptionDecorator(exceptionDecorator: ExceptionDecorator | null | undefined) {
...
function reportException(e: ExtendedError, isFatal: boolean) {
  ...
  if (NativeExceptionsManager) {
    ...
    const isHandledByLogBox = e.forceRedbox !== true && global.__unstable_isLogBoxEnabled === true;
