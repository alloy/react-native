...
class ImageBackground extends React.Component<$FlowFixMeProps> {
  ...
  _viewRef: React.ElementRef<typeof View> | null | undefined = null;
  ...
  render(): React.ReactNode {
    ...
    return <View accessibilityIgnoresInvertColors={true} style={style} ref={this._captureRef}>
