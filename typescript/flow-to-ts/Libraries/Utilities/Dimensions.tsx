yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Utilities/Dimensions.js
'use strict';
...
import NativeDeviceInfo, { DisplayMetrics, DimensionsPayload } from "./NativeDeviceInfo";
...
let initialDims: $ReadOnly<{
  [key: string]: any;
}> | null | undefined = global.nativeExtensions && global.nativeExtensions.DeviceInfo && global.nativeExtensions.DeviceInfo.Dimensions;
if (!initialDims) {
  // Subscribe before calling getConstants to make sure we don't miss any updates in between.
  RCTDeviceEventEmitter.addListener('didUpdateDimensions', (update: DimensionsPayload) => {
