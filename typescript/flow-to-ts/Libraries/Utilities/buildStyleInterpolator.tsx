yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Utilities/buildStyleInterpolator.js
'use strict';
...
const computeTransform = function (anim, name, value, result, didChange, didMatrix) {
  const transform = result.transform !== undefined ? result.transform : result.transform = [{ matrix: [] }];
