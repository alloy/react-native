yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Components/TextInput/AndroidTextInputNativeComponent.js
'use strict';
...
export type NativeProps = $ReadOnly<$Diff<ViewProps, $ReadOnly<{style: ViewStyleProp | null | undefined;}>> & {
  /**
   ...
   */
  onBlur?: BubblingEventHandler<$ReadOnly<{target: Int32;}>> | null | undefined;

  /**
   * Callback that is called when the text input is focused.
   * `target` is the reactTag of the element
   */
  onFocus?: BubblingEventHandler<$ReadOnly<{target: Int32;}>> | null | undefined;
   ...
   */
  onChange?: BubblingEventHandler<$ReadOnly<{target: Int32;eventCount: Int32;text: string;}>> | null | undefined;
   ...
   * TODO: differentiate between onChange and onChangeText
   */
  onChangeText?: BubblingEventHandler<$ReadOnly<{target: Int32;eventCount: Int32;text: string;}>> | null | undefined;
   ...
   */
  onEndEditing?: BubblingEventHandler<$ReadOnly<{target: Int32;text: string;}>> | null | undefined;
   ...
   */
  onSubmitEditing?: BubblingEventHandler<$ReadOnly<{target: Int32;text: string;}>> | null | undefined;
   ...
   */
  onKeyPress?: BubblingEventHandler<$ReadOnly<{target: Int32;key: string;}>> | null | undefined;
  ...
  textShadowOffset?: $ReadOnly<{width?: Double | null | undefined;height?: Double | null | undefined;}> | null | undefined;
...
if (global.RN$Bridgeless) {
  ...
  AndroidTextInputNativeComponent = requireNativeComponent<NativeProps>('AndroidTextInput');
}

// flowlint-next-line unclear-type:off
export default ((AndroidTextInputNativeComponent as any) as HostComponent<NativeProps>);
Done in 0.55s.
