yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Components/TextInput/InputAccessoryView.js
'use strict';
...
class InputAccessoryView extends React.Component<Props> {
  ...
  render(): React.ReactNode {
    ...
    return <RCTInputAccessoryViewNativeComponent style={[this.props.style, styles.container]} nativeID={this.props.nativeID} backgroundColor={this.props.backgroundColor}>
        {this.props.children}
