yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Components/ScrollView/ScrollView.js
'use strict';
...
export type ScrollResponderType = typeof ScrollResponder.Mixin & {
...
export type Props = $ReadOnly<ViewProps & IOSProps & AndroidProps & VRProps & {
  ...
  "none" // cross-platform
  | "on-drag" | "interactive") | null | undefined;
  // ios only
...
type State = ScrollResponderState & {
...
class ScrollView extends React.Component<Props, State> {
   ...
   */
  scrollToEnd(options?: {animated?: boolean;} | null | undefined) {
    // Default to true
  ...
  _setStickyHeaderRef(key: string, ref: React.ElementRef<StickyHeaderComponentType> | null | undefined) {
    if (ref) {
  ...
  _scrollViewRef: React.ElementRef<HostComponent<unknown>> | null | undefined = null;
  _setScrollViewRef = (ref: React.ElementRef<HostComponent<unknown>> | null | undefined) => {
    this._scrollViewRef = ref;
  };

  _innerViewRef: React.ElementRef<HostComponent<unknown>> | null | undefined = null;
  _setInnerViewRef = (ref: React.ElementRef<HostComponent<unknown>> | null | undefined) => {
  ...
  render(): React.ReactNode | React.ReactElement<string> {
    ...
    if (refreshControl) {
      if (Platform.OS === 'ios') {
        ...
        return React.cloneElement(refreshControl, { style: [baseStyle, outer] }, <ScrollViewClass {...props} style={[baseStyle, inner]} ref={this._setScrollViewRef}>
            {contentContainer}
          </ScrollViewClass>);
      }
    }
