yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Components/ScrollView/ScrollViewStickyHeader.js
'use strict';
...
class ScrollViewStickyHeader extends React.Component<Props, State> {
  ...
  render(): React.ReactNode {
    ...
    return <AnimatedView collapsable={false} onLayout={this._onLayout} style={[child.props.style, styles.header, { transform: [{ translateY }] }]}>
