yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Components/Picker/AndroidDialogPickerNativeComponent.js
'use strict';
...
export default (requireNativeComponent<NativeProps>('AndroidDialogPicker') as NativeType);
Done in 0.48s.
