...
type Props = $ReadOnly<AndroidProps & IOSProps & {
  /**
...
class StatusBar extends React.Component<Props> {
   ...
   * @platform android
   */
  static currentHeight: number | null | undefined = Platform.OS === 'android' ? NativeStatusBarManagerAndroid.getConstants().HEIGHT : null;
