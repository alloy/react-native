yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Components/DrawerAndroid/DrawerLayoutAndroid.android.js
'use strict';
...
class DrawerLayoutAndroid extends React.Component<Props, State> {
  ...
  render(): React.ReactNode {
    ...
    const childrenWrapper = <View style={styles.mainSubview} collapsable={false}>
        ...
        {drawStatusBar && <View style={[styles.statusBar, { backgroundColor: this.props.statusBarBackgroundColor }]} />}
        {this.props.children}
      </View>;
