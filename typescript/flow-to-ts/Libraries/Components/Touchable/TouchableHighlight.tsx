...
type Props = $ReadOnly<React.ElementConfig<TouchableWithoutFeedback> & AndroidProps & IOSProps & {
...
type State = $ReadOnly<{
  ...
  extraStyles: ExtraStyles | null | undefined;
}>;
...
class TouchableHighlight extends React.Component<Props, State> {
  ...
  _hideTimeout: TimeoutID | null | undefined;
