yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Components/ToastAndroid/ToastAndroid.android.js
'use strict';
...
const ToastAndroid = {
  ...
  SHORT: (NativeToastAndroid.getConstants().SHORT as number),
  LONG: (NativeToastAndroid.getConstants().LONG as number),
  // Toast gravity constants
  TOP: (NativeToastAndroid.getConstants().TOP as number),
  BOTTOM: (NativeToastAndroid.getConstants().BOTTOM as number),
  CENTER: (NativeToastAndroid.getConstants().CENTER as number),
  ...
  showWithGravityAndOffset: function (message: string, duration: number, gravity: number, xOffset: number, yOffset: number): void {
    NativeToastAndroid.showWithGravityAndOffset(message, duration, gravity, xOffset, yOffset);
  }
};
