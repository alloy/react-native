yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Inspector/BoxInspector.js
'use strict';
...
class BoxInspector extends React.Component<$FlowFixMeProps> {
  ...
  render(): React.ReactNode {
    ...
    return <BoxContainer title="margin" titleStyle={styles.marginLabel} box={margin}>
