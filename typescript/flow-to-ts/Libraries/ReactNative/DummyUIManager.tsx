...
export default {
  ...
  createView: (reactTag: number | null | undefined, viewName: string, rootTag: number, props: any) => {},
  updateView: (reactTag: number, viewName: string, props: any) => {},
  ...
  measureLayout: (reactTag: number | null | undefined, ancestorReactTag: number | null | undefined, errorCallback: ((error: any) => void), callback: ((left: number, top: number, width: number, height: number) => void)) => {},
  measureLayoutRelativeToParent: (reactTag: number | null | undefined, errorCallback: ((error: any) => void), callback: ((left: number, top: number, width: number, height: number) => void)) => {},
  setJSResponder: (reactTag: number | null | undefined, blockNativeResponder: boolean) => {},
  clearJSResponder: () => {},
  configureNextLayoutAnimation: (config: any, callback: (() => void), errorCallback: ((error: any) => void)) => {},
  ...
  showPopupMenu: (reactTag: number | null | undefined, items: Array<string>, error: ((error: any) => void), success: ((event: string, selected?: number) => void)) => {},
  dismissPopupMenu: () => {}
};;
