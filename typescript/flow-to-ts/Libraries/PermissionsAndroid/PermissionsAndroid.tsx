yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/PermissionsAndroid/PermissionsAndroid.js
'use strict';
...
class PermissionsAndroid {
  ...
  async request(permission: PermissionType, rationale?: Rationale): Promise<PermissionStatus> {
    ...
    if (rationale) {
      const shouldShowRationale = await NativePermissionsAndroid.shouldShowRequestPermissionRationale(permission);
      ...
      if (shouldShowRationale && !!NativeDialogManagerAndroid) {
        return new Promise((resolve, reject) => {
          ...
          options, () => reject(new Error('Error showing rationale')), () => resolve(NativePermissionsAndroid.requestPermission(permission)));
        });
      }
    }
