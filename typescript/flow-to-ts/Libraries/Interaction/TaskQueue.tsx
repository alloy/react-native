yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/Interaction/TaskQueue.js
'use strict';
    ...
    if (queue.length) {
      ...
      try {
        if (task.gen) {
          ...
          this._genPromise((task as any)); // Rather than annoying tagged union
        } else if (task.run) {
