...
const PanResponder = {
   ...
   */
  _updateGestureStateOnMove(gestureState: GestureState, touchHistory: $PropertyType<PressEvent, "touchHistory">) {
  ...
  create(config: PanResponderConfig): $TEMPORARY$object<{
    ...
    const interactionState = {
      handle: (null as number | null | undefined)
    };
...
function clearInteractionHandle(interactionState: {handle: number | null | undefined;}, callback: (ActiveCallback | PassiveCallback) | null | undefined, event: PressEvent, gestureState: GestureState) {
  if (interactionState.handle) {
