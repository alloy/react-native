yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/LogBox/UI/LogBoxInspectorStackFrames.js
'use strict';
...
function StackFrameList(props) {
  return <>
      ...
      return <LogBoxInspectorStackFrame key={index} frame={frame} onPress={props.status === 'COMPLETE' && file != null && lineNumber != null ? () => openFileInEditor(file, lineNumber) : null} />;
    })}
    </>;
}

function StackFrameFooter(props) {
  return <View style={stackStyles.collapseContainer}>
      <LogBoxButton backgroundColor={{
      default: 'transparent',
      pressed: LogBoxStyle.getBackgroundColor(1)
    }} onPress={props.onPress} style={stackStyles.collapseButton}>
