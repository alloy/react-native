yarn run v1.21.1
$ /Users/eloy/Code/ReactNative/react-native/node_modules/.bin/flow-to-ts Libraries/LogBox/UI/LogBoxNotification.js
'use strict';
...
function CountBadge(props) {
  return <View style={countStyles.outside}>
      {
...
function Message(props) {
  return <View style={messageStyles.container}>
      <Text numberOfLines={1} style={messageStyles.text}>
        {props.message && <LogBoxMessage plaintext message={props.message} style={messageStyles.substitutionText} />}
      </Text>
    </View>;
}

function DismissButton(props) {
  return <View style={dismissStyles.container}>
      ...
      bottom: 12,
      left: 10
    }} onPress={props.onPress} style={dismissStyles.press}>
        <Image source={{
        width: 8,
        height: 8,
