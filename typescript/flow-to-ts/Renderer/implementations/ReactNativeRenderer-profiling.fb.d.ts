declare var ReactNativePrivateInterface: any, React: any, Scheduler: any, tracing: any, eventPluginOrder: any, namesToPlugins: {};
...
declare var enableNativeTargetAsInstance: any, instanceCache: any, instanceProps: any;
declare var restoreTarget: any, restoreQueue: any;
declare var isInsideEventHandler: boolean;
declare var EMPTY_NATIVE_EVENT: {};
...
declare var ReactNativeFiberHostComponent: (tag: any, viewConfig: any) => void;
declare var getViewConfigForType: any, UPDATE_SIGNAL: {}, nextReactTag: number;
declare var scheduleTimeout: typeof setTimeout, cancelTimeout: typeof clearTimeout, BEFORE_SLASH_RE: RegExp;
...
declare var fakeCallbackNode: {}, requestPaint: any, syncQueue: any, immediateQueueCallbackNode: any, isFlushingSyncQueue: boolean, initialTimeMs: any, now: any;
...
declare var ContextOnlyDispatcher: {
    ...
    useDeferredValue: (value: any, config: any) => any;
    useTransition: (config: any) => any[];
}, now$1: any, commitTime: number, profilerStartTime: number;
declare var hydrationParentFiber: any, nextHydratableInstance: any, isHydrating: boolean;
...
declare var roots: any, ReactNativeRenderer: {
    ...
    unmountComponentAtNodeAndRemoveContainer: (containerTag: any) => void;
    ...
    __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: {
        ...
        computeComponentStackForErrorReporting: (reactTag: any) => string;
    };
};
declare var ReactNativeRenderer$2: {
    default: {
        NativeComponent: () => any;
        findHostInstance_DEPRECATED: (componentOrHandle: any) => any;
        findNodeHandle: typeof findNodeHandle;
