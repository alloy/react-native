...
class PushNotificationIOS {
  ...
  static getInitialNotification(): Promise<PushNotificationIOS | undefined | null> {
    invariant(NativePushNotificationManagerIOS, 'PushNotificationManager is not available.');
    return NativePushNotificationManagerIOS.getInitialNotification().then(notification => {
  ...
  getMessage(): (string | undefined | null) | (object | undefined | null) {
  ...
  getSound(): string | undefined | null {
    return this._sound;
  }
  /**
  ...
  getCategory(): string | undefined | null {
  ...
  getAlert(): (string | undefined | null) | (object | undefined | null) {
    return this._alert;
  }
  /**
  ...
  getBadgeCount(): number | undefined | null {
  ...
  getThreadID(): string | undefined | null {
