...
class Alert {
  static alert(title?: string | null, message?: string | null, buttons?: Buttons, options?: Options): void {
    if (Platform.OS === 'ios') {
      ...
      const validButtons: Buttons = buttons ? buttons.slice(0, 3) : [{
  ...
  static prompt(title?: string | null, message?: string | null, callbackOrButtons?: (((text: string) => void) | Buttons) | null, type: AlertType | undefined | null = 'plain-text', defaultValue?: string, keyboardType?: string): void {
    if (Platform.OS === 'ios') {
