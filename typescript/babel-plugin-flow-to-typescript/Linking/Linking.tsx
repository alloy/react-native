...
class Linking extends NativeEventEmitter {
  ...
  getInitialURL(): Promise<string | undefined | null> {
    return Platform.OS === 'android' ? InteractionManager.runAfterInteractions().then(() => NativeLinking.getInitialURL()) : NativeLinking.getInitialURL();
  }
  /*
