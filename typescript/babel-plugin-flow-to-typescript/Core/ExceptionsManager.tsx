...
type ExceptionDecorator = (a: ExceptionData) => ExceptionData;
let userExceptionDecorator: ExceptionDecorator | undefined | null;
...
function unstable_setExceptionDecorator(exceptionDecorator?: ExceptionDecorator | null) {
