...
module.exports = {
   ...
   */
  getColorScheme(): ColorSchemeName | undefined | null {
    // TODO: (hramos) T52919652 Use ?ColorSchemeName once codegen supports union
    const nativeColorScheme: string | undefined | null = NativeAppearance == null ? null : NativeAppearance.getColorScheme() || null;
