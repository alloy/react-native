...
type Props = Readonly<{
  forwardedRef: React.Ref<"RCTText" | "RCTVirtualText"> | undefined | null;
} & TextProps>;
type State = {
  touchable: {
    touchState: string | undefined | null;
    responderID: number | undefined | null;
  };
  isHighlighted: boolean;
  createResponderHandlers: () => ResponseHandlers;
  responseHandlers: ResponseHandlers | undefined | null;
};
...
class TouchableText extends React.Component<Props, State> {
  ...
  touchableGetPressRectOffset: (() => PressRetentionOffset) | undefined | null;
  touchableHandleActivePressIn: (() => void) | undefined | null;
  touchableHandleActivePressOut: (() => void) | undefined | null;
  touchableHandleLongPress: ((event: PressEvent) => void) | undefined | null;
  touchableHandlePress: ((event: PressEvent) => void) | undefined | null;
  touchableHandleResponderGrant: ((event: PressEvent, dispatchID: string) => void) | undefined | null;
  touchableHandleResponderMove: ((event: PressEvent) => void) | undefined | null;
  touchableHandleResponderRelease: ((event: PressEvent) => void) | undefined | null;
  touchableHandleResponderTerminate: ((event: PressEvent) => void) | undefined | null;
  touchableHandleResponderTerminationRequest: (() => boolean) | undefined | null;
...
const Text = (props: TextProps, forwardedRef?: React.Ref<"RCTText" | "RCTVirtualText"> | null) => {
  return <TouchableText {...props} forwardedRef={forwardedRef} />;
};

const TextToExport = React.forwardRef(Text);
TextToExport.displayName = 'Text'; // TODO: Deprecate this.
