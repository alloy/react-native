...
export declare type ____ViewStyle_Internal = Readonly<{
    ...
    elevation?: number;
} & ____LayoutStyle_Internal & ____ShadowStyle_Internal & ____TransformStyle_Internal>;
export declare type ____FontWeight_Internal = "normal" | "bold" | "100" | "200" | "300" | "400" | "500" | "600" | "700" | "800" | "900";
export declare type ____TextStyle_Internal = Readonly<{
    color?: ColorValue;
    fontFamily?: string;
    fontSize?: number;
...
export declare type ____ImageStyle_Internal = Readonly<{
    resizeMode?: "contain" | "cover" | "stretch" | "center" | "repeat";
    tintColor?: ColorValue;
    overlayColor?: string;
} & ____ViewStyle_Internal>;
export declare type ____DangerouslyImpreciseStyle_Internal = {
...
export declare type ____DangerouslyImpreciseStyleProp_Internal = GenericStyleProp<Partial<____DangerouslyImpreciseStyle_Internal>>;
export declare type ____ViewStyleProp_Internal = GenericStyleProp<Readonly<Partial<____ViewStyle_Internal>>>;
export declare type ____TextStyleProp_Internal = GenericStyleProp<Readonly<Partial<____TextStyle_Internal>>>;
export declare type ____ImageStyleProp_Internal = GenericStyleProp<Readonly<Partial<____ImageStyle_Internal>>>;
