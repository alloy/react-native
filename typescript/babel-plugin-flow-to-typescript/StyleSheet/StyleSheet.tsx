...
module.exports = {
   ...
   * styles.
   */
  absoluteFill: (absoluteFill as any),
   ...
   */
  compose<T extends DangerouslyImpreciseStyleProp>(style1: T | undefined | null, style2: T | undefined | null): (T | undefined | null) | ReadonlyArray<T> {
