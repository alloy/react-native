...
export type ____DangerouslyImpreciseStyleProp_Internal = GenericStyleProp<Partial<____DangerouslyImpreciseStyle_Internal>>;
export type ____ViewStyleProp_Internal = GenericStyleProp<Readonly<Partial<____ViewStyle_Internal>>>;
export type ____TextStyleProp_Internal = GenericStyleProp<Readonly<Partial<____TextStyle_Internal>>>;
export type ____ImageStyleProp_Internal = GenericStyleProp<Readonly<Partial<____ImageStyle_Internal>>>;
