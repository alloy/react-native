...
class EventEmitter {
  ...
  _currentSubscription: EmitterSubscription | undefined | null;
  /**
   * @constructor
   *
  ...
  once(eventType: string, listener: Function, context?: object | null): EmitterSubscription {
  ...
  removeAllListeners(eventType?: string | null) {
  ...
  listeners(eventType: string): [EmitterSubscription] {
    ...
    .filter(sparseFilterPredicate).map(subscription => subscription.listener) : [];
  }
  /**
