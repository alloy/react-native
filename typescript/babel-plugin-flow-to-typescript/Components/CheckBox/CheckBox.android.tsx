...
type Props = Readonly<{
   ...
   */
  forwardedRef?: React.Ref<typeof AndroidCheckBoxNativeComponent> | null;
...
class CheckBox extends React.Component<Props> {
  _nativeRef: React.ElementRef<typeof AndroidCheckBoxNativeComponent> | undefined | null = null;
  ...
  _onChange = (event: CheckBoxEvent) => {
    ...
    AndroidCheckBoxCommands.setNativeValue(nullthrows(this._nativeRef), value); // Change the props after the native props are set in case the props
