...
type PickerItemSelectSyntheticEvent = SyntheticEvent<Readonly<{
  position: number;
}>>;
...
type Props = Readonly<{
  ...
  selectedValue?: PickerItemValue | null;
  enabled?: boolean | null;
  mode?: ("dialog" | "dropdown") | null;
  onValueChange?: ((itemValue: PickerItemValue | undefined | null, itemIndex: number) => unknown) | null;
  prompt?: string | null;
  testID?: string;
}>;
/**
