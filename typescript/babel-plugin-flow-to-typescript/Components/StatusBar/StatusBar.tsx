...
type IOSProps = Readonly<{
   ...
   * @platform ios
   */
  networkActivityIndicatorVisible?: boolean | null;
...
type Props = Readonly<{
   ...
   */
  barStyle?: ("default" | "light-content" | "dark-content") | null;
...
class StatusBar extends React.Component<Props> {
  ...
  static _updateImmediate = null; // The current merged values from the props stack.

  static _currentValues = null; // TODO(janic): Provide a real API to deal with status bar height. See the
  // discussion in #6195.
  ...
  static currentHeight: number | undefined | null = Platform.OS === 'android' ? NativeStatusBarManagerAndroid.getConstants().HEIGHT : null; // Provide an imperative API as static functions of the component.
  ...
  static _updatePropsStack = () => {
    ...
    StatusBar._updateImmediate = setImmediate(() => {
      ...
      const mergedProps = mergePropsStack(StatusBar._propsStack, StatusBar._defaultProps); // Update the props that have changed using the merged values from the props stack.
