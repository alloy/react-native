...
type Event = SyntheticEvent<Readonly<{
  value: number;
...
type Props = Readonly<{
   ...
   */
  onSlidingComplete?: ((value: number) => void) | null;
...
const Slider = (props: Props, forwardedRef?: React.Ref<typeof SliderNativeComponent> | null) => {
