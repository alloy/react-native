...
import { Props as ScrollViewProps } from './ScrollView/ScrollView';
...
const ScrollResponderMixin = {
  _subscriptionKeyboardWillShow: (null as EmitterSubscription | undefined | null),
  _subscriptionKeyboardWillHide: (null as EmitterSubscription | undefined | null),
  _subscriptionKeyboardDidShow: (null as EmitterSubscription | undefined | null),
  _subscriptionKeyboardDidHide: (null as EmitterSubscription | undefined | null),
   ...
   *
   */
  scrollResponderHandleStartShouldSetResponder: function (e: PressEvent): boolean {
    // Allow any event touch pass through if the default pan responder is disabled
    if (this.props.disableScrollViewPanResponder === true) {
      return false;
    }
   ...
   */
  scrollResponderHandleStartShouldSetResponderCapture: function (e: PressEvent): boolean {
  ...
  scrollResponderHandleScroll: function (e: ScrollEvent) {
    (this as any).state.observedScrollSinceBecomingResponder = true;
    (this as any).props.onScroll && (this as any).props.onScroll(e);
  },
  ...
  scrollResponderHandleScrollEndDrag: function (e: ScrollEvent) {
    const {
      velocity
    } = e.nativeEvent; // - If we are animating, then this is a "drag" that is stopping the scrollview and momentum end
    //   will fire.
   ...
   */
  scrollResponderGetScrollableNode: function (): number | undefined | null {
   ...
   */
  scrollResponderScrollTo: function (x?: number | {
    x?: number;
    y?: number;
    animated?: boolean;
    ...
    const that: React.ElementRef<ScrollView> = (this as any);
   ...
   */
  scrollResponderScrollNativeHandleToKeyboard: function <T>(nodeHandle: number | React.ElementRef<HostComponent<T>> | React.ElementRef<Class<ReactNative.NativeComponent<T>>>, additionalOffset?: number, preventNegativeScrollOffset?: boolean) {
  ...
  UNSAFE_componentWillMount: function () {
    const {
      keyboardShouldPersistTaps
    } = ((this as any).props as ScrollViewProps);
    ...
    (this as any).keyboardWillOpenTo = null;
    (this as any).additionalScrollOffset = 0;
