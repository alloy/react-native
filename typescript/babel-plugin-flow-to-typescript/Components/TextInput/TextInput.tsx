...
export type ChangeEvent = SyntheticEvent<Readonly<{
  eventCount: number;
  target: number;
  text: string;
}>>;
export type TextInputEvent = SyntheticEvent<Readonly<{
  eventCount: number;
  previousText: string;
  range: Readonly<{
    start: number;
...
export type ContentSizeChangeEvent = SyntheticEvent<Readonly<{
  target: number;
...
type TargetEvent = SyntheticEvent<Readonly<{
  target: number;
}>>;
...
export type SelectionChangeEvent = SyntheticEvent<Readonly<{
  selection: Selection;
  target: number;
}>>;
export type KeyPressEvent = SyntheticEvent<Readonly<{
  key: string;
  target?: number | null;
  eventCount?: number | null;
}>>;
export type EditingEvent = SyntheticEvent<Readonly<{
  eventCount: number;
  text: string;
  target: number;
}>>;
...
type IOSProps = Readonly<{
   ...
   * @platform ios
   */
  enablesReturnKeyAutomatically?: boolean | null;
   ...
   * @platform ios
   */
  dataDetectorTypes?: (DataDetectorTypesType | undefined | null) | ReadonlyArray<DataDetectorTypesType>;
...
type AndroidProps = Readonly<{
   ...
   * @platform android
   */
  inlineImagePadding?: number | null;
...
export type Props = Readonly<{
   ...
   */
  onBlur?: ((e: BlurEvent) => unknown) | null;

  /**
   * Callback that is called when the text input is focused.
   */
  onFocus?: ((e: FocusEvent) => unknown) | null;

  /**
   * Callback that is called when the text input's text changes.
   */
  onChange?: ((e: ChangeEvent) => unknown) | null;

  /**
   * Callback that is called when the text input's text changes.
   * Changed text is passed as an argument to the callback handler.
   */
  onChangeText?: ((text: string) => unknown) | null;
   ...
   */
  onContentSizeChange?: ((e: ContentSizeChangeEvent) => unknown) | null;

  /**
   * Callback that is called when text input ends.
   */
  onEndEditing?: ((e: EditingEvent) => unknown) | null;
   ...
   */
  onSelectionChange?: ((e: SelectionChangeEvent) => unknown) | null;

  /**
   * Callback that is called when the text input's submit button is pressed.
   * Invalid if `multiline={true}` is specified.
   */
  onSubmitEditing?: ((e: EditingEvent) => unknown) | null;
   ...
   */
  onKeyPress?: ((e: KeyPressEvent) => unknown) | null;
   ...
   */
  onScroll?: ((e: ScrollEvent) => unknown) | null;

  /**
   * The string that will be rendered before text input has been entered.
   */
  placeholder?: Stringish | null;
  ...
  forwardedRef?: ReactRefSetter<React.ElementRef<HostComponent<unknown>> & ImperativeMethods> | null;
...
type ImperativeMethods = Readonly<{
  clear: () => void;
  isFocused: () => boolean;
  getNativeRef: () => React.ElementRef<HostComponent<unknown>> | undefined | null;
}>;

const emptyFunctionThatReturnsTrue = () => true;

function useFocusOnMount(initialAutoFocus: boolean | undefined | null, inputRef: {
  current: null | React.ElementRef<HostComponent<unknown>>;
}) {
  const initialAutoFocusValue = useRef<boolean | undefined | null>(initialAutoFocus);
  useEffect(() => {
...
function InternalTextInput(props: Props): React.Node {
  ...
  const selection: Selection | undefined | null = props.selection == null ? null : {
    start: props.selection.start,
    end: props.selection.end ?? props.selection.start
  };
  const [lastNativeText, setLastNativeText] = useState<Stringish | undefined | null>(props.value);
  const [lastNativeSelection, setLastNativeSelection] = useState<Selection | undefined | null>(selection); // This is necessary in case native updates the text and JS decides
  ...
  function getNativeRef(): React.ElementRef<HostComponent<unknown>> | undefined | null {
    return inputRef.current;
  }

  function _getText(): string | undefined | null {
...
ExportedForwardRef.propTypes = DeprecatedTextInputPropTypes; // $FlowFixMe
