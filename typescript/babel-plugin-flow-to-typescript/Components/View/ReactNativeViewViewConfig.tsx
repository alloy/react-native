...
const ReactNativeViewConfig = {
  ...
  Commands: ({} as {}),
  Constants: ({} as {}),
  bubblingEventTypes: { ...ReactNativeViewViewConfigAndroid.bubblingEventTypes,
    topBlur: {
  ...
  directEventTypes: { ...ReactNativeViewViewConfigAndroid.directEventTypes,
  ...
  validAttributes: { ...ReactNativeViewViewConfigAndroid.validAttributes,
    ...
    height: true,
    hitSlop: {
      diff: (require('../../Utilities/differ/insetsDiffer') as any)
    },
