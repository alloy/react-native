...
type SwitchChangeEvent = SyntheticEvent<Readonly<{
  value: boolean;
}>>;
...
class Switch extends React.Component<Props> {
  _nativeSwitchRef: React.ElementRef<typeof SwitchNativeComponent | typeof AndroidSwitchNativeComponent> | undefined | null;
  _lastNativeValue: boolean | undefined | null;
  ...
  render(): React.Node {
    const {
      ...
      value,
      ...props
    } = this.props; // Support deprecated color props.

    let _thumbColor = thumbColor;

    let _trackColorForFalse = trackColor?.false;

    let _trackColorForTrue = trackColor?.true; // TODO: Remove support for these props after a couple releases.
  ...
  _handleSwitchNativeComponentRef = (ref?: React.ElementRef<typeof SwitchNativeComponent | typeof AndroidSwitchNativeComponent> | null) => {
