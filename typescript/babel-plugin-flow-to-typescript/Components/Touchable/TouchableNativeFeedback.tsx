...
class TouchableNativeFeedback extends React.Component<Props, State> {
  ...
  render(): React.Node {
    ...
    return React.cloneElement(element, { ...eventHandlersWithoutBlurAndFocus,
...
const getBackgroundProp = Platform.OS === 'android' ? (background, useForeground) => useForeground && TouchableNativeFeedback.canUseNativeForeground() ? {
