...
type Props = Readonly<{
  onPressAnimationComplete?: (() => void) | null;
  onPressWithCompletion?: ((callback: () => void) => void) | null;
  releaseBounciness?: number | null;
...
class TouchableBounce extends React.Component<Props, State> {
  ...
  _bounceTo(toValue: number, velocity: number, bounciness: number, callback?: (() => void) | null) {
...
module.exports = (React.forwardRef((props, hostRef) => <TouchableBounce {...props} hostRef={hostRef} />) as React.ComponentType<Readonly<Omit<Props, "hostRef">>>);