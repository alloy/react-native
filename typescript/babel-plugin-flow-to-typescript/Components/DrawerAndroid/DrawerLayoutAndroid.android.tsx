...
type Props = Readonly<{
   ...
   */
  drawerPosition: ("left" | "right") | undefined | null;
   ...
   */
  onDrawerSlide?: DirectEventHandler<DrawerSlideEvent> | null;
   ...
   */
  onDrawerStateChanged?: ((state: DrawerStates) => unknown) | null;

  /**
   * Function called whenever the navigation view has been opened.
   */
  onDrawerOpen?: (() => unknown) | null;

  /**
   * Function called whenever the navigation view has been closed.
   */
  onDrawerClose?: (() => unknown) | null;
   ...
   * effect on API 21+.
   */
  statusBarBackgroundColor?: ColorValue | null;
  children?: React.Node;
...
class DrawerLayoutAndroid extends React.Component<Props, State> {
  ...
  _nativeRef = React.createRef<React.ElementRef<typeof AndroidDrawerLayoutNativeComponent>>();
  state: State = {
  ...
  render(): React.Node {
    ...
    const drawerViewWrapper = <View style={[styles.drawerSubview, {
    ...
    const childrenWrapper = <View style={styles.mainSubview} collapsable={false}>
        {drawStatusBar && <StatusBar translucent backgroundColor={this.props.statusBarBackgroundColor} />}
        {drawStatusBar && <View style={[styles.statusBar, {
        backgroundColor: this.props.statusBarBackgroundColor
      }]} />}
        {this.props.children}
      </View>;
    return <AndroidDrawerLayoutNativeComponent {...props} ref={this._nativeRef} drawerWidth={this.props.drawerWidth} drawerPosition={this.props.drawerPosition} drawerLockMode={this.props.drawerLockMode} style={[styles.base, this.props.style]} onDrawerSlide={this._onDrawerSlide} onDrawerOpen={this._onDrawerOpen} onDrawerClose={this._onDrawerClose} onDrawerStateChanged={this._onDrawerStateChanged}>
        {childrenWrapper}
        {drawerViewWrapper}
