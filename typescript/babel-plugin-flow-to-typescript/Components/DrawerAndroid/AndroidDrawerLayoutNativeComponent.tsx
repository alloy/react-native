...
type NativeProps = Readonly<{
   ...
   */
  onDrawerStateChanged?: DirectEventHandler<DrawerStateEvent> | null;

  /**
   * Function called whenever the navigation view has been opened.
   */
  onDrawerOpen?: DirectEventHandler<null, "topDrawerOpened"> | null;

  /**
   * Function called whenever the navigation view has been closed.
   */
  onDrawerClose?: DirectEventHandler<null, "topDrawerClosed"> | null;
...
export default (codegenNativeComponent<NativeProps>('AndroidDrawerLayout') as NativeType);