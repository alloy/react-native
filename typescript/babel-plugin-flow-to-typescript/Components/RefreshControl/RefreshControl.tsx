...
class RefreshControl extends React.Component<RefreshControlProps> {
  ...
  _nativeRef: React.ElementRef<typeof PullToRefreshViewNativeComponent | typeof AndroidSwipeRefreshLayoutNativeComponent> | undefined | null;
  ...
  _onRefresh = () => {
    ...
    this.props.onRefresh && this.props.onRefresh(); // The native component will start refreshing so force an update to
    // make sure it stays in sync with the js component.

    this.forceUpdate();
  };
  _setNativeRef = (ref?: React.ElementRef<typeof PullToRefreshViewNativeComponent | typeof AndroidSwipeRefreshLayoutNativeComponent> | null) => {
    this._nativeRef = ref;
  };
}
