...
const PanResponder = {
  ...
  create(config: PanResponderConfig): $TEMPORARY$object<{
    getInteractionHandle: () => number | undefined | null;
    ...
    const interactionState = {
      handle: (null as number | undefined | null)
    };
...
}, callback: (ActiveCallback | PassiveCallback) | undefined | null, event: PressEvent, gestureState: GestureState) {
  if (interactionState.handle) {
...
export type PanResponderInstance = $Call1<typeof PanResponder["create"], PanResponderConfig>;
