...
const ActionSheetIOS = {
  ...
  showActionSheetWithOptions(options: {
    ...
    readonly destructiveButtonIndex?: (number | undefined | null) | (Array<number> | undefined | null);
    ...
    RCTActionSheetManager.showActionSheetWithOptions({ ...remainingOptions,
  ...
  showShareActionSheetWithOptions(options: object, failureCallback: Function, successCallback: Function) {
    ...
    invariant(RCTActionSheetManager, "ActionSheetManager does't exist");
    RCTActionSheetManager.showShareActionSheetWithOptions({ ...options,
