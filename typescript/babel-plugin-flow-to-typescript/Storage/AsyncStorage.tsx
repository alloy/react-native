...
import invariant from 'invariant'; // Use SQLite if available, otherwise file storage.
...
const AsyncStorage = {
  _getRequests: ([] as Array<any>),
  _getKeys: ([] as Array<string>),
  _immediate: (null as number | undefined | null),
   ...
   */
  getItem: function (key: string, callback?: ((error?: Error | null, result?: string | null) => void) | undefined | null): Promise {
   ...
   */
  setItem: function (key: string, value: string, callback?: ((error?: Error | null) => void) | undefined | null): Promise {
    invariant(RCTAsyncStorage, 'RCTAsyncStorage not available');
    return new Promise((resolve, reject) => {
   ...
   */
  removeItem: function (key: string, callback?: ((error?: Error | null) => void) | undefined | null): Promise {
    invariant(RCTAsyncStorage, 'RCTAsyncStorage not available');
    return new Promise((resolve, reject) => {
   ...
   */
  mergeItem: function (key: string, value: string, callback?: ((error?: Error | null) => void) | undefined | null): Promise {
    invariant(RCTAsyncStorage, 'RCTAsyncStorage not available');
    return new Promise((resolve, reject) => {
   ...
   */
  clear: function (callback?: ((error?: Error | null) => void) | undefined | null): Promise {
    invariant(RCTAsyncStorage, 'RCTAsyncStorage not available');
    return new Promise((resolve, reject) => {
   ...
   */
  getAllKeys: function (callback?: ((error?: Error | null, keys?: Array<string> | null) => void) | undefined | null): Promise {
    invariant(RCTAsyncStorage, 'RCTAsyncStorage not available');
    return new Promise((resolve, reject) => {
   ...
   */
  multiGet: function (keys: Array<string>, callback?: ((errors?: Array<Error> | null, result?: Array<Array<string>> | null) => void) | undefined | null): Promise {
    if (!this._immediate) {
   ...
   */
  multiSet: function (keyValuePairs: Array<Array<string>>, callback?: ((errors?: Array<Error> | null) => void) | undefined | null): Promise {
    invariant(RCTAsyncStorage, 'RCTAsyncStorage not available');
    return new Promise((resolve, reject) => {
   ...
   */
  multiRemove: function (keys: Array<string>, callback?: ((errors?: Array<Error> | null) => void) | undefined | null): Promise {
    invariant(RCTAsyncStorage, 'RCTAsyncStorage not available');
    return new Promise((resolve, reject) => {
   ...
   */
  multiMerge: function (keyValuePairs: Array<Array<string>>, callback?: ((errors?: Array<Error> | null) => void) | undefined | null): Promise {
    invariant(RCTAsyncStorage, 'RCTAsyncStorage not available');
    return new Promise((resolve, reject) => {
