...
class WebSocket extends (EventTarget(...WEBSOCKET_EVENTS) as any) {
  ...
  _binaryType: BinaryType | undefined | null;
  onclose: Function | undefined | null;
  onerror: Function | undefined | null;
  onmessage: Function | undefined | null;
  onopen: Function | undefined | null;
  ...
  constructor(url: string, protocols: (string | undefined | null) | (Array<string> | undefined | null), options?: {
    headers?: {
      origin?: string;
    };
  } | null) {
    ...
    const {
      headers = {},
      ...unrecognized
    } = options || {}; // Preserve deprecated backwards compatibility for the 'origin' option
  ...
  get binaryType(): BinaryType | undefined | null {
