...
const _combineCallbacks = function (callback: EndCallback | undefined | null, config: AnimationConfig) {
...
const maybeVectorAnim = function (value: AnimatedValue | AnimatedValueXY, config: object, anim: (value: AnimatedValue, config: object) => CompositeAnimation): CompositeAnimation | undefined | null {
  if (value instanceof AnimatedValueXY) {
    ...
    const aY = anim((value as AnimatedValueXY).y, configY); // We use `stopTogether: false` here because otherwise tracking will break
...
const spring = function (value: AnimatedValue | AnimatedValueXY, config: SpringAnimationConfig): CompositeAnimation {
  const start = function (animatedValue: AnimatedValue | AnimatedValueXY, configuration: SpringAnimationConfig, callback?: EndCallback | undefined | null): void {
  ...
  return maybeVectorAnim(value, config, spring) || {
    start: function (callback?: EndCallback | undefined | null): void {
...
const timing = function (value: AnimatedValue | AnimatedValueXY, config: TimingAnimationConfig): CompositeAnimation {
  const start = function (animatedValue: AnimatedValue | AnimatedValueXY, configuration: TimingAnimationConfig, callback?: EndCallback | undefined | null): void {
    callback = _combineCallbacks(callback, configuration);
    const singleValue: any = animatedValue;
    const singleConfig: any = configuration;
    singleValue.stopTracking();
...
const decay = function (value: AnimatedValue | AnimatedValueXY, config: DecayAnimationConfig): CompositeAnimation {
  const start = function (animatedValue: AnimatedValue | AnimatedValueXY, configuration: DecayAnimationConfig, callback?: EndCallback | undefined | null): void {
    callback = _combineCallbacks(callback, configuration);
    const singleValue: any = animatedValue;
    const singleConfig: any = configuration;
    singleValue.stopTracking();
...
const sequence = function (animations: Array<CompositeAnimation>): CompositeAnimation {
  let current = 0;
  return {
    start: function (callback?: EndCallback | undefined | null) {
...
const parallel = function (animations: Array<CompositeAnimation>, config?: ParallelConfig | undefined | null): CompositeAnimation {
...
function forkEvent(event: (AnimatedEvent | undefined | null) | (Function | undefined | null), listener: Function): AnimatedEvent | Function {
  if (!event) {
    return listener;
...
function unforkEvent(event: (AnimatedEvent | undefined | null) | (Function | undefined | null), listener: Function): void {
  if (event && event instanceof AnimatedEvent) {
    event.__removeListener(listener);
  }
}

const event = function (argMapping: ReadonlyArray<Mapping | undefined | null>, config: EventConfig): any {
