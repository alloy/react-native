...
function createAnimatedComponent<Props extends {
  ...
  class AnimatedComponent extends React.Component<object> {
    ...
    _setComponentRef = setAndForwardRef({
      ...
      setLocalRef: ref => {
        ...
        if (ref != null && ref.getNode == null) {
          ref.getNode = () => {
            console.warn('%s: Calling `getNode()` on the ref of an Animated component ' + 'is no longer necessary. You can now directly use the ref ' + 'instead. This method will be removed in a future release.', ref.constructor.name ?? '<<anonymous>>');
            return ref;
          };
        }
      }
    ...
    render() {
      ...
      return <Component {...props} ref={this._setComponentRef} // The native driver updates views directly through the UI thread so we
  ...
  return React.forwardRef(function AnimatedComponentWrapper(props, ref) {
    return <AnimatedComponent {...props} {...ref == null ? null : {
      forwardedRef: ref
    }} />;
  });
}
