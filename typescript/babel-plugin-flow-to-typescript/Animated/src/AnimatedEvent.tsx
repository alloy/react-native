...
function attachNativeEvent(viewRef: any, eventName: string, argMapping: ReadonlyArray<Mapping | undefined | null>): {
  detach: () => void;
} {
...
class AnimatedEvent {
  _argMapping: ReadonlyArray<Mapping | undefined | null>;
  ...
  constructor(argMapping: ReadonlyArray<Mapping | undefined | null>, config: EventConfig) {
