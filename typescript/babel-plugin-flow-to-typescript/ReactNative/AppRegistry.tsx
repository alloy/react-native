...
export type WrapperComponentProvider = (a: any) => React$ComponentType<any>;
...
let componentProviderInstrumentationHook: ComponentProviderInstrumentationHook = (component: ComponentProvider) => component();

let wrapperComponentProvider: WrapperComponentProvider | undefined | null;
...
const AppRegistry = {
  ...
  getRunnable(appKey: string): Runnable | undefined | null {
  ...
  runApplication(appKey: string, appParameters: any): void {
    if (appKey !== 'LogBox') {
      const msg = 'Running "' + appKey + '" with ' + JSON.stringify(appParameters);
      infoLog(msg);
