...
type Props = Readonly<{
  ...
  WrapperComponent?: React.ComponentType<any> | null;
  internal_excludeLogBox?: boolean | null;
}>;
type State = {
  inspector: React.Node | undefined | null;
  mainKey: number;
  hasError: boolean;
};
...
class AppContainer extends React.Component<Props, State> {
  ...
  _mainRef: React.ElementRef<typeof View> | undefined | null;
  _subscription: EmitterSubscription | undefined | null = null;
