...
type OnSuccessCallback = (left: number, top: number, width: number, height: number, pageX: number, pageY: number) => void; // I don't know what type error is...
...
const queryLayoutByID = function (tag: number | undefined | null, onError: OnErrorCallback, onSuccess: OnSuccessCallback): void {
  if (tag == null) {
    return;
