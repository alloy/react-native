...
export type Response = (object | undefined | null) | string;
type XHRInterceptor = {
...
class XMLHttpRequestEventTarget extends (EventTarget(...REQUEST_EVENTS) as any) {
  onload: Function | undefined | null;
  onloadstart: Function | undefined | null;
  onprogress: Function | undefined | null;
  ontimeout: Function | undefined | null;
  onerror: Function | undefined | null;
  onabort: Function | undefined | null;
  onloadend: Function | undefined | null;
}
/**
...
class XMLHttpRequest extends (EventTarget(...XHR_EVENTS) as any) {
  ...
  static _interceptor: XHRInterceptor | undefined | null = null;
  UNSENT: number = UNSENT;
  OPENED: number = OPENED;
  HEADERS_RECEIVED: number = HEADERS_RECEIVED;
  LOADING: number = LOADING;
  DONE: number = DONE; // EventTarget automatically initializes these to `null`.
  ...
  onabort: Function | undefined | null;
  onloadend: Function | undefined | null;
  onreadystatechange: Function | undefined | null;
  readyState: number = UNSENT;
  responseHeaders: object | undefined | null;
  status: number = 0;
  timeout: number = 0;
  responseURL: string | undefined | null;
  withCredentials: boolean = true;
  upload: XMLHttpRequestEventTarget = new XMLHttpRequestEventTarget();
  _requestId: number | undefined | null;
  ...
  _method: string | undefined | null = null;
  _response: string | (object | undefined | null);
  _responseType: ResponseType;
  _response: string = '';
  _sent: boolean;
  _url: string | undefined | null = null;
  ...
  __didReceiveResponse(requestId: number, status: number, responseHeaders?: object | null, responseURL?: string | null): void {
    if (requestId === this._requestId) {
      this.status = status;
  ...
  __didReceiveIncrementalData(requestId: number, responseText: string, progress: number, total: number) {
    if (requestId !== this._requestId) {
      return;
    }
  ...
  getAllResponseHeaders(): string | undefined | null {
  ...
  getResponseHeader(header: string): string | undefined | null {
  ...
  open(method: string, url: string, async?: boolean | null): void {
  ...
  send(data: any): void {
    ...
    const doSend = () => {
      ...
      nativeResponseType, incrementalEvents, this.timeout, this.__didCreateRequest.bind(this), this.withCredentials);
    };
  ...
  setResponseHeaders(responseHeaders?: object | null): void {
