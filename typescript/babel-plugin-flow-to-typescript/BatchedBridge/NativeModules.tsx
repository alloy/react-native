...
export type ModuleConfig = [string, object | undefined | null, ReadonlyArray<string> | undefined | null, ReadonlyArray<number> | undefined | null, ReadonlyArray<number> | undefined | null];
export type MethodType = "async" | "promise" | "sync";

function genModule(config: ModuleConfig | undefined | null, moduleID: number): {
  name: string;
  module?: object;
} | undefined | null {
  if (!config) {
...
function loadModule(name: string, moduleID: number): object | undefined | null {
...
function updateErrorWithErrorData(errorData: {
  message: string;
}, error: ExtendedError): ExtendedError {
