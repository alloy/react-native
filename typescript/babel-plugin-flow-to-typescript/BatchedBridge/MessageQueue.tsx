...
const METHOD_IDS = 1;
const PARAMS = 2;
const MIN_TIME_BETWEEN_FLUSHES_MS = 5; // eslint-disable-next-line no-bitwise
...
class MessageQueue {
  _lazyCallableModules: {
    [key: string]: (a: void) => object;
  };
  _queue: [number[], number[], any[], number];
  _successCallbacks: Map<number, Function | undefined | null>;
  _failureCallbacks: Map<number, Function | undefined | null>;
  _callID: number;
  _lastFlush: number;
  _eventLoopStartTime: number;
  _immediatesCallback: (() => void) | undefined | null;
  _debugInfo: {
  ...
  _remoteMethodTable: {
    [x: number]: ReadonlyArray<string>;
  };
  __spy: ((data: SpyData) => void) | undefined | null;
  ...
  constructor() {
    ...
    (this as any).callFunctionReturnFlushedQueue = this.callFunctionReturnFlushedQueue.bind(this);
    (this as any).callFunctionReturnResultAndFlushedQueue = this.callFunctionReturnResultAndFlushedQueue.bind(this);
    (this as any).flushedQueue = this.flushedQueue.bind(this);
    (this as any).invokeCallbackAndReturnFlushedQueue = this.invokeCallbackAndReturnFlushedQueue.bind(this);
  }
  /**
   * Public APIs
   */
  ...
  callFunctionReturnResultAndFlushedQueue(module: string, method: string, args: any[]): $TEMPORARY$array<[Array<number>, Array<number>, Array<any>, number] | undefined | null> {
    let result;
  ...
  registerLazyCallableModule(name: string, factory: (a: void) => object) {
    let module: object;
    let getValue: ((a: void) => object) | undefined | null = factory;
  ...
  callNativeSyncHook(moduleID: number, methodID: number, params: any[], onFail?: Function | null, onSucc?: Function | null): any {
    if (__DEV__) {
  ...
  processCallbacks(moduleID: number, methodID: number, params: any[], onFail?: Function | null, onSucc?: Function | null) {
    if (onFail || onSucc) {
      if (__DEV__) {
  ...
  enqueueNativeCall(moduleID: number, methodID: number, params: any[], onFail?: Function | null, onSucc?: Function | null) {
    this.processCallbacks(moduleID, methodID, params, onFail, onSucc);
    ...
    if (__DEV__) {
      ...
      deepFreezeAndThrowOnMutationInDev((params as any));
    }
  ...
  createDebugLookup(moduleID: number, name: string, methods?: ReadonlyArray<string> | null) {
    if (__DEV__) {
  ...
  __invokeCallback(cbID: number, args: any[]) {
    ...
    const callID = cbID >>> 1; // eslint-disable-next-line no-bitwise
