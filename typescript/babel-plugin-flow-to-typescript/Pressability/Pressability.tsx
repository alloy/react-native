...
import { normalizeRect, RectOrSize } from '../StyleSheet/Rect.js';
...
export type PressabilityConfig = Readonly<{
   ...
   */
  hitSlop?: RectOrSize | null;

  /**
   * Amount to extend the `HitRect` by to create `PressRect`.
   */
  pressRectOffset?: RectOrSize | null;
   ...
   */
  onHoverIn?: ((event: MouseEvent) => unknown) | null;

  /**
   * Called when the hover is deactivated to undo visual feedback.
   */
  onHoverOut?: ((event: MouseEvent) => unknown) | null;
   ...
   */
  onPressIn?: ((event: PressEvent) => unknown) | null;

  /**
   * Called when the press location moves. (This should rarely be used.)
   */
  onPressMove?: ((event: PressEvent) => unknown) | null;

  /**
   * Called when the press is deactivated to undo visual feedback.
   */
  onPressOut?: ((event: PressEvent) => unknown) | null;

  /**
   * Returns whether a long press gesture should cancel the press gesture.
   * Defaults to true.
   */
  onLongPressShouldCancelPress_DEPRECATED?: (() => boolean) | null;
   ...
   */
  onResponderTerminationRequest_DEPRECATED?: (() => boolean) | null;
   ...
   * @deprecated
   */
  onStartShouldSetResponder_DEPRECATED?: (() => boolean) | null;
}>;
...
type TouchSignal = "DELAY" | "RESPONDER_GRANT" | "RESPONDER_RELEASE" | "RESPONDER_TERMINATED" | "ENTER_PRESS_RECT" | "LEAVE_PRESS_RECT" | "LONG_PRESS_DETECTED";
...
export default class Pressability {
  ...
  _eventHandlers: EventHandlers | undefined | null = null;
  _hoverInDelayTimeout: TimeoutID | undefined | null = null;
  _hoverOutDelayTimeout: TimeoutID | undefined | null = null;
  _isHovered: boolean = false;
  _longPressDelayTimeout: TimeoutID | undefined | null = null;
  _pressDelayTimeout: TimeoutID | undefined | null = null;
  _pressOutDelayTimeout: TimeoutID | undefined | null = null;
  _responderID: (number | undefined | null) | React.ElementRef<HostComponent<unknown>> = null;
  ...
  _isTouchWithinResponderRegion(touch: PressEvent["nativeEvent"], responderRegion: Readonly<{
    bottom: number;
    left: number;
    right: number;
    top: number;
