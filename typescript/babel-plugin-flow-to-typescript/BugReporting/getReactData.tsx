...
function getData(element: object): object {
  ...
  let nodeType = 'Native'; // If the parent is a native node without rendered children, but with
  ...
  if (element._currentElement != null) {
    ...
    if (typeof type === 'string') {
      ...
      nodeType = 'Composite';
      name = element.getName(); // 0.14 top-level wrapper
  ...
  if (element._instance) {
    ...
    publicInstance = inst; // TODO: React ART currently falls in this bucket, but this doesn't
...
function setInProps(internalInst, path: Array<string | number>, value: any) {
  ...
  internalInst._currentElement = { ...element,
