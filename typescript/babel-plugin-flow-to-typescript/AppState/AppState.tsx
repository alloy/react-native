...
class AppState extends NativeEventEmitter {
  ...
  constructor() {
    ...
    let eventUpdated = false; // TODO: this is a terrible solution - in order to ensure `currentState`
  ...
  addEventListener(type: string, handler: Function) {
    ...
    switch (type) {
      ...
      case 'focus':
        {
          this._eventHandlers[type].set(handler, this.addListener('appStateFocusChange', hasFocus => {
...
class MissingNativeAppStateShim extends EventEmitter {
  ...
  currentState: string | undefined | null = null;
