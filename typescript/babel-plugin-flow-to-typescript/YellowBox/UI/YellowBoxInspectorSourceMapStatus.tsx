...
type State = {
  animation: CompositeAnimation | undefined | null;
  rotate: AnimatedInterpolation | undefined | null;
};
...
class YellowBoxInspectorSourceMapStatus extends React.Component<Props, State> {
  ...
  render(): React.Node {
    ...
    return image == null ? null : <YellowBoxPressable backgroundColor={{
      ...
      right: 8,
      top: 8
    }} onPress={this.props.onPress} style={StyleSheet.compose(styles.root, this.props.status === 'PENDING' ? styles.pending : null)}>
