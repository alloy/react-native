...
class ViewabilityHelper {
  ...
  computeViewableItems(itemCount: number, scrollOffset: number, viewportHeight: number, getFrameMetrics: (index: number) => {
    length: number;
    offset: number;
  } | undefined | null, // Optional optimization to reduce the scan size
  renderRange?: {
    first: number;
    last: number;
  }): Array<number> {
  ...
  onUpdate(itemCount: number, scrollOffset: number, viewportHeight: number, getFrameMetrics: (index: number) => {
    length: number;
    offset: number;
  } | undefined | null, createViewToken: (index: number, isViewable: boolean) => ViewToken, onViewableItemsChanged: (a: {
    viewableItems: Array<ViewToken>;
    changed: Array<ViewToken>;
