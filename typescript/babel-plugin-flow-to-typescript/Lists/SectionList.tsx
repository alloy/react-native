...
export type Props<SectionT> = {} & Omit<VirtualizedSectionListProps<SectionT>, "getItem" | "getItemCount" | "renderItem"> & RequiredProps<SectionT> & OptionalProps<SectionT>;
const defaultProps = { ...VirtualizedSectionList.defaultProps,
...
class SectionList<SectionT extends SectionBase<any>> extends React.PureComponent<Props<SectionT>, void> {
  ...
  _wrapperListRef: React.ElementRef<typeof VirtualizedSectionList> | undefined | null;
  _captureRef = ref => {
