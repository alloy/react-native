...
class FileReader extends (EventTarget(...READER_EVENTS) as any) {
  ...
  _error: Error | undefined | null;
  _result: ReaderResult | undefined | null;
  ...
  readAsText(blob?: Blob | null, encoding: string = 'UTF-8') {
    this._aborted = false;
  ...
  abort() {
    this._aborted = true; // only call onreadystatechange if there is something to abort, as per spec
  ...
  get error(): Error | undefined | null {
    return this._error;
  }

  get result(): ReaderResult | undefined | null {
    return this._result;
  }
