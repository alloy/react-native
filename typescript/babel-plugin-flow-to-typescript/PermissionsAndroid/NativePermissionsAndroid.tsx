...
import * as TurboModuleRegistry from '../TurboModule/TurboModuleRegistry'; // TODO: Use proper enum types.
...
export default (TurboModuleRegistry.get<Spec>('PermissionsAndroid') as Spec | undefined | null);