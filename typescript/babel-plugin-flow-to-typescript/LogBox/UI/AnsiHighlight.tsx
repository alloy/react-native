...
import { TextStyleProp } from 'react-native/Libraries/StyleSheet/StyleSheet'; // Afterglow theme from https://iterm2colorschemes.com/
...
export default function Ansi({
  ...
  return <View style={{
    flexDirection: 'column'
      ...
      {parsedLines.map((items, i) => <View style={{
      flexDirection: 'row'
    }} key={i}>
