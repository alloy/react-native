...
function unstable_setLogListeners(listeners: LogListeners | null | undefined) {
 ...
 */
const deepDiffer = function (one: any, two: any, maxDepthOrOptions: Options | number = -1, maybeOptions?: Options): boolean {
