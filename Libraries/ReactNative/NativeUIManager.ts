...
export interface Spec extends TurboModule {
  ...
  readonly measureLayout: (reactTag: number | null | undefined, ancestorReactTag: number | null | undefined, errorCallback: (error: Object) => void, callback: (left: number, top: number, width: number, height: number) => void) => void;
  readonly measureLayoutRelativeToParent: (reactTag: number | null | undefined, errorCallback: (error: Object) => void, callback: (left: number, top: number, width: number, height: number) => void) => void;
  ...
  readonly showPopupMenu: (reactTag: number | null | undefined, items: Array<string>, error: (error: Object) => void, success: (event: string, selected?: number) => void) => void;
